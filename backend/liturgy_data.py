...
"season": "comune",
"text": "È veramente cosa buona e giusta, nostro dovere e fonte di salvezza, rendere grazie sempre e in ogni luogo a te, Signore, Padre santo, Dio onnipotente ed eterno, per Cristo Signore nostro.\n\nIn lui hai voluto rinnovare l'universo, perché noi tutti fossimo partecipi della sua pienezza. Pur essendo nella condizione di Dio, egli svuotò se stesso, e con il sangue versato sulla croce pacificò il cielo e la terra. Per questo fu esaltato sopra ogni creatura e divenne causa di salvezza eterna per tutti coloro che gli obbediscono.\n\nE noi, uniti agli angeli e agli arcangeli, ai troni e alle dominazioni e alla moltitudine delle schiere celesti, cantiamo con voce incessante l'inno della tua gloria:"
},
{
"id": "comune_2",
"title": "Prefazio Comune II - La salvezza per mezzo di Cristo",
"season": "comune",
"text": "È veramente cosa buona e giusta, nostro dovere e fonte di salvezza, rendere grazie sempre e in ogni luogo a te, Signore, Padre santo, Dio onnipotente ed eterno, per Cristo nostro Signore.\n\nNella tua bontà hai creato l'uomo e, quando meritò la giusta condanna, lo hai redento nella tua misericordia, per Cristo nostro Signore.\n\nPer mezzo di lui gli angeli lodano la tua gloria, le dominazioni ti adorano, le potenze ti venerano con tremore; a te inneggiano i cieli dei cieli e i serafini, uniti in eterna esultanza. Al loro canto concedi, o Signore, che si uniscano le nostre umili voci nell'inno di lode:"
},
{
"id": "avvento_1",
"title": "Prefazio dell'Avvento I - Le due venute di Cristo",
"season": "avvento",
"text": "È veramente cosa buona e giusta, nostro dovere e fonte di salvezza, rendere grazie sempre e in ogni luogo a te, Signore, Padre santo, Dio onnipotente ed eterno, per Cristo nostro Signore.\n\nAl suo primo avvento nell'umiltà della condizione umana egli portò a compimento la promessa antica, e ci aprì la via dell'eterna salvezza. Quando verrà di nuovo nello splendore della gloria, ci chiamerà a possedere il regno promesso che ora osiamo sperare vigilanti nell'attesa.\n\nE noi, uniti agli angeli e agli arcangeli, ai troni e alle dominazioni e alla moltitudine dei cori celesti, cantiamo con voce incessante l'inno della tua gloria:"
},
{
"id": "natale_1",
...
{
"id": "ordinario_2",
"title": "Prefazio Tempo Ordinario II - Il mistero della redenzione",
"season": "ordinario",
"text": "È veramente cosa buona e giusta, nostro dovere e fonte di salvezza, rendere grazie sempre e in ogni luogo a te, Signore, Padre santo, Dio onnipotente ed eterno, per Cristo nostro Signore.\n\nNella sua misericordia per noi peccatori egli si è degnato di nascere dalla Vergine; morendo sulla croce, ci ha liberati dalla morte eterna e con la sua risurrezione ci ha donato la vita immortale.\n\nPer questo mistero di salvezza, con gli angeli e gli arcangeli, i troni, le dominazioni, e con tutte le schiere celesti, cantiamo senza fine l'inno della tua gloria:"
}
]
